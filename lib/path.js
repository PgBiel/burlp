(function() {
  var handler, passPropFunc, pathTools, pathjoin, requester, snekfetch, toStrings, util,
  ...
  requester = snekfetch != null ? passPropFunc(snekfetch, true) : function(path) {
    return {};
  };
  ...
  pathTools = module.exports = {
    pathGen: function(prefix, initial, req, passProp) {
      ...
      if ((req != null) && !passProp && typeof req !== "function") {
